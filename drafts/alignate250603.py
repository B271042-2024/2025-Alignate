        ...
        for group in self.groups:
            if group['layout_seq'] == layout:
                group['widget_seq'] = [
                    ...
                    if entry['widget_row'] not in [r for r, _ in seq_removed]
                ]
...
#        fig, ax = plt.subplots(figsize=(len(aa) * 0.15, 0.4))  # 0.15 in ~ 15 pixels
    ...
    def compute_region_conservation(self, prediction_text):
        ...
        for group in self.groups:
            ...
            layout_result.addWidget(lbl_second)
...
#_______________________________________________________________________________________________
#_______________________________________________________________________________________________5 Codon (Do in different file)
#_______________________________________________________________________________________________
