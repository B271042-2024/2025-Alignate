...
# --------------------------------------------Connect
        ...
        print('before: testing apply new consensus threshold')
        with open(self.aligned_aa_output_file, 'r') as f:
            lines = f.readlines()
            print(lines)
        print('after: testing apply new consensus threshold')
...
# -------2 Run Alignment: AA Sequences via mafft or clustalO
        ...
        with open(self.aligned_aa_output_file, 'r') as aligned_aa_file:
